...
function* loginUser(action) {
  ...
  try {
    ...
    if (data.error == true) {
      ...
      if (data.user.roles.rolesId == 1) {
        action.payload.history.push(constants.ADMIN_DIR_SCENE)
      }
      else if (data.user.roles.rolesId == 2) {
        action.payload.history.push(constants.CUSTOMER_DIR_SCENE)
      }
      else if (data.user.roles.rolesId == 3) {
        action.payload.history.push(constants.SUB_CUSTOMER_DIR_SCENE)
      }
      else {
